package com.hwq.mvvm.live.business;
...
import com.hwq.mvvm.live.utils.FspToken;
...
public class FspManager implements IFspEngineEventHandler{
    ...
    public static final String DEFAULT_APP_SECRET = "0b5c0e02d00dae93";
    public static final String DEFAULT_APP_ID = "0b7d7ce5e417a5d61e8300c3616c1086";
    ...
    public boolean joinGroup(String groupId, String userId) {
        ...
        if (m_fspEngine == null) {
            m_fspEngine = FspEngine.create(Utils.getContext(), appId, "", this);
        }
