package com.hwq.mvvm.live.utils;
...
public class CheckListDialog extends Dialog {
    ...
    public CheckListDialog(@NonNull Context context, String title, ArrayList<String> items, int selectedIndex, CheckListDialogListener listener) {
        super(context, R.style.CheckListDlgStyle);
