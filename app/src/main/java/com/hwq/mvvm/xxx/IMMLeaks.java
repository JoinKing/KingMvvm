...
public class IMMLeaks {
     ...
     */
    public static void fixFocusedViewLeak(Application application) {//Application application) {
        ...
        } catch (Exception e) {//(NoSuchMethodException | NoSuchFieldException unexpected) {
    ...
    static class ReferenceCleaner
        ...
        private void clearInputMethodManagerLeak() {
            ...
            } catch (Exception e) {//IllegalAccessException | InvocationTargetException unexpected) {
                Log.e("IMMLeaks", "Unexpected reflection exception", e);
            }
        }
