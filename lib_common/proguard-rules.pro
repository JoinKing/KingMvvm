...
#---------------------------------4.反射相关的类和方法-----------------------
-keep public class * extends com.hwq.lib_common.base.BaseActivity{ *; }
-keep public class * extends com.hwq.lib_common.base.BaseFragment{ *; }
-keep public class * extends com.hwq.lib_common.binding.command.BindingCommand{ *; }
-keep public class * extends com.hwq.lib_common.binding.command.ResponseCommand{ *; }
...
-keep class com.hwq.lib_common.widget.** { *; }
